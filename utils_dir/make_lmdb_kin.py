...
if __name__ == '__main__':
    make_dataset_lmdb(dataset_path='/apdcephfs/private_yangelfang/yujiazhang/dataset/frame_downsize_kinetics_400_mmlab_1f_320/val_test',
                      filename='/apdcephfs/private_yangelfang/yujiazhang/dataset/lmdb')
